                        ...
                        <View style={{flexDirection: 'row'}}>
                            <View style={{flex: 2}}>
                                <Picker
                                    style={{marginLeft: 10}}
                                    selectedValue={marca}
                                    onValueChange={(itemValue) => onChangeMarca(itemValue)}>
                                    <Picker.Item label='[ Marca ]' value=''/>
                                    {marcas_vehiculo.map((item, index) => (
                                        <Picker.Item label={item.description}
                                                     value={item.value}
                                                     key={index}/>)
                                    )}
                                </Picker>
                            ...
                            <View style={{flex: 2}}>
                                <Picker
                                    ...
                                    enabled={modelos_vehiculo.length > 0}
                                    onValueChange={(itemValue) => onChangeModelo(itemValue)}>
                                    <Picker.Item label='[ Modelo ]' value=''/>
                                    {modelos_vehiculo.map((item, index) => (
                                        <Picker.Item label={item.description}
                                                     value={item.value}
                                                     key={index}/>)
                                    )}
                            ...
                            <View style={{flex: 2}}>
                                <Picker
                                    ...
                                    selectedValue={ano}
                                    enabled={modelos_vehiculo.length > 0}
                                    onValueChange={(itemValue) => onChangeAno(itemValue)}>
                                    <Picker.Item label='[ Año ]' value=''/>
                                    {anos_vehiculo.map((item, index) => (
                                        <Picker.Item label={item.toString()}
                                                     value={item}
                                                     key={index}/>)
                                    )}
                                </Picker>
